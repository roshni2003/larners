...
import React, { useState } from 'react';
import { Card, CardContent, Typography, TextField, Button, Grid, useMediaQuery } from '@mui/material';
import { styled } from '@mui/system';
  ...
  return (
    <StyledCard elevation={3}>
      ...
      {donationSuccess && (
        <CardContent>
          <Typography variant="h5" gutterBottom>
            Thank You for Your Donation: 🙏🏼 This Donation for Educational Purpose
          </Typography>
          <Typography variant="subtitle1" gutterBottom>
            Amount Donated: ${donationSuccess.amount.toFixed(2)}
          </Typography>
